...
6.Depending on which opeating system using(currently only supports Win 10 32 and Win 10 64), please download the "rxtxSerial.dll" file 
  in Win32/Win64 folder and place it under /lib folder.
